    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserve_list', models.PositiveIntegerField(default=0, verbose_name='Lista rezerwowa')),
                ('description', tinymce.models.HTMLField(blank=True, verbose_name='Opis wydarzenia')),
                ...
                ('reservation_end_time', models.DateTimeField(blank=True, help_text='Po tej godzinie rezerwacja online nie będzie możliwa.', null=True, verbose_name='Koniec przyjmowania rezerwacji')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('confirmed', 'Potwierdzona'), ('waitlist', 'Lista rezerwowa'), ('cancelled', 'Anulowana')], default='confirmed', max_length=20, verbose_name='Status rezerwacji')),
                ('waitlist_position', models.PositiveIntegerField(blank=True, help_text="Pozycja na liście rezerwowej (tylko dla rezerwacji w statusie 'Lista rezerwowa')", null=True, verbose_name='Pozycja na liście rezerwowej')),
                ('cancellation_token', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='Token anulowania')),
                ('participants_count', models.PositiveIntegerField(default=1, help_text='Podaj liczbę osób biorących udział w spotkaniu.', validators=[django.core.validators.MinValueValidator(1, 'Liczba uczestników musi wynosić co najmniej 1'), django.core.validators.MaxValueValidator(100, 'Maksymalna liczba uczestników to 100')], verbose_name='Liczba uczestników')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Data utworzenia')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='events.events', verbose_name='Wydarzenie')),
                ('guest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='guest_reservations', to='accounts.guestuser', verbose_name='Gość')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_reservations', to=settings.AUTH_USER_MODEL, verbose_name='Użytkownik zarejestrowany')),
            ],
            options={
